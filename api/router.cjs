...
const {verificarAsientosDisponibles} = require('./controller/funcionesController.cjs')
const {peliculasValidacionEncontrarAsientos} = require("./validators/funcionesValidator.cjs")
